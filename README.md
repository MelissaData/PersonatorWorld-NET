...
# Personator World API C# REST Sample Code

This is a sample code for Melissa's Personator World API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Personator World Web Service and how to call the service in C#. 
